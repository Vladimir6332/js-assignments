...
function getAverage(value1, value2) {
    ...
    if (value1 > 0 && value2 > 0) {
        if (value1 > value2) return value1 - (value1 - value2) / 2;
        else return value1 + (value2 - value1) / 2;
    } else if (value1 < 0 && value2 < 0) {
        if (value1 > value2) return value1 - (value2 - value1) / 2;
        else return value1 - (value1 - value2) / 2;
    } else {
        if (value1 > value2) return (value2 + value1) / 2;
